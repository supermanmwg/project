...
/**
 * Content Provider used to store information about weather data returned from
 * the Weather Service web service.
 */
public class WeatherProvider extends ContentProvider {

	/**
	 * The database helper that is used to manage the providers database.
	 */
	...
	public boolean onCreate() {
		mDataBaseHelper = new WeatherDatabaseHelper(getContext(),
				WeatherDatabaseHelper.DATABASE_NAME, null,
	...
	private static String addKeyIdCheckToWhereStatement(String whereStatement,
		...
		return newWhereStatement + " _id = " + "'" + id + "'";
	}
	...
	public Cursor query(Uri uri, String[] projection, String whereStatement,
		...
		case WeatherContract.WEATHER_VALUES_ITEMS:
			queryBuilder
					.setTables(WeatherValuesEntry.WEATHER_VALUES_TABLE_NAME);
			break;
		case WeatherContract.WEATHER_VALUES_ITEM:
			queryBuilder
					.setTables(WeatherValuesEntry.WEATHER_VALUES_TABLE_NAME);
			whereStatement = addKeyIdCheckToWhereStatement(whereStatement,
		...
		final Cursor cursor = queryBuilder.query(
				mDataBaseHelper.getReadableDatabase(), projection,
				whereStatement, whereStatementArgs, null, // GROUP BY (not used)
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		long weatherId = db.insert(
				WeatherValuesEntry.WEATHER_VALUES_TABLE_NAME, null, values);
	...
	public int bulkInsert(Uri uri, ContentValues[] values) {
		...
		case WeatherContract.WEATHER_VALUES_ITEM:
		case WeatherContract.WEATHER_VALUES_ITEMS:
			dbName = WeatherValuesEntry.WEATHER_VALUES_TABLE_NAME;
			break;
		default:
			throw new IllegalArgumentException("Unknown URI " + uri);
		}
	 ...
	 */
	@Override
	public int delete(Uri uri, String whereStatement,
		...
		case WeatherContract.WEATHER_VALUES_ITEM:
			rowsDeleted = db.delete(
					...
					addKeyIdCheckToWhereStatement(whereStatement,
							ContentUris.parseId(uri)), whereStatementArgs);
			break;
		default:
			throw new IllegalArgumentException("Unknown URI " + uri);
		}
	 ...
	 */
	@Override
	public int update(Uri uri, ContentValues values, String whereStatement,
			String[] whereStatementArgs) {
		...
		case WeatherContract.WEATHER_VALUES_ITEMS:
			rowsUpdated = db.update(
					WeatherValuesEntry.WEATHER_VALUES_TABLE_NAME, values,
					whereStatement, whereStatementArgs);
			break;
		case WeatherContract.WEATHER_VALUES_ITEM:
			rowsUpdated = db.update(
