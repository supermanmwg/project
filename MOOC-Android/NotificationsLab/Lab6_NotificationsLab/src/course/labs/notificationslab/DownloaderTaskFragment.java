...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> list = getArguments().getIntegerArrayList(
	...
	public class DownloaderTask extends
			AsyncTask<ArrayList<Integer>, Integer, String[]> {

		@Override
		protected String[] doInBackground(ArrayList<Integer>... params) {
			// TODO Auto-generated method stub
			Integer[] resourceId = params[0].toArray(new Integer[params[0]
					.size()]);
					...
					new BroadcastReceiver() {
						...
						public void onReceive(Context context, Intent intent) {
							...
							if (resultCode != MainActivity.IS_ALIVE) {
								...
								PendingIntent mContentIntent = PendingIntent
