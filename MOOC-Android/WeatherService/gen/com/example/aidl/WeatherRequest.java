...
public static abstract class Stub extends android.os.Binder implements com.example.aidl.WeatherRequest
{
private static final java.lang.String DESCRIPTOR = "com.example.aidl.WeatherRequest";
...
/**
 * Cast an IBinder object into an com.example.aidl.WeatherRequest interface,
 * generating a proxy if needed.
 */
public static com.example.aidl.WeatherRequest asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.example.aidl.WeatherRequest))) {
return ((com.example.aidl.WeatherRequest)iin);
}
return new com.example.aidl.WeatherRequest.Stub.Proxy(obj);
}
...
com.example.aidl.WeatherResults _arg1;
_arg1 = com.example.aidl.WeatherResults.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements com.example.aidl.WeatherRequest
{
...
/**
    ...
    */
@Override public void getCurrentWeather(java.lang.String Weather, com.example.aidl.WeatherResults results) throws android.os.RemoteException
{
...
/**
    ...
    * to the WeatherActivity via the one-way sendResults() method.
    */
public void getCurrentWeather(java.lang.String Weather, com.example.aidl.WeatherResults results) throws android.os.RemoteException;
}
